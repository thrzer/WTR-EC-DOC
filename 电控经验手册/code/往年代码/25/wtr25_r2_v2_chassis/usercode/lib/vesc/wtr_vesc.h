...
#endif 
#ifndef wtrcfg_VESC_COMMAND_BRAKE_CURRENT_MAX
#define wtrcfg_VESC_COMMAND_BRAKE_CURRENT_MAX 100
#endif 
...
#define VESC_CAN_SET_DUTY(vesc,duty) 					can_send_command(vesc,CAN_PACKET_SET_DUTY,duty,1)
#define VESC_CAN_SET_CURRENT(vesc,current)  	can_send_command(vesc,CAN_PACKET_SET_CURRENT,current,1)
#define VESC_CAN_SET_ERPM(vesc,erpm)				  can_send_command(vesc,CAN_PACKET_SET_RPM,erpm,1)
#define VESC_CAN_SET_POS(vesc,pos) 				 	  can_send_command(vesc,CAN_PACKET_SET_POS,pos,1)
#define VESC_CAN_SET_BRAKE_CURRENT(vesc,current) can_send_command(vesc,CAN_PACKET_SET_CURRENT_BRAKE,current,1)
