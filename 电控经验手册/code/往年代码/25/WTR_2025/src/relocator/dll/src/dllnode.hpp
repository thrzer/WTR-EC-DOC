...
public:
	...
	bool checkUpdateThresholds()
	{
		...
		// pose.header.stamp=last_cloud_time;
		// pose.header.frame_id=m_globalFrameId;
		// pose.pose.pose.position.x=m_lastGlobalTf.getOrigin().x();
		// pose.pose.pose.position.y=m_lastGlobalTf.getOrigin().y();
		// pose.pose.pose.position.z=m_lastGlobalTf.getOrigin().z();
		// pose.pose.pose.orientation.x=m_lastGlobalTf.getRotation().x();
		// pose.pose.pose.orientation.y=m_lastGlobalTf.getRotation().y();
		// pose.pose.pose.orientation.z=m_lastGlobalTf.getRotation().z();
		// pose.pose.pose.orientation.w=m_lastGlobalTf.getRotation().w();
		// m_initialPosePub->publish(pose);
		...
		try
		{
			m_tfBuffer->canTransform(m_odomFrameId, m_baseFrameId, last_cloud_time);
